...
/* Thermal MSR reserved bits */
#define MSR_IA32_CLOCK_MODULATION_RSV_BITS		(~0x1FUL)
#define MSR_IA32_THERM_STATUS_RSV_BITS			(~0xAAAUL)
#define MSR_IA32_THERM_INTERRUPT_RSV_BITS		(~0x1FFFF1FUL)
#define MSR_IA32_PACKAGE_THERM_STATUS_RSV_BITS		(~0xAA2UL)
#define MSR_IA32_PACKAGE_THERM_INTERRUPT_RSV_BITS	(~0x1FFFF17UL)
...
/* Machine Check bits */
#define	MSR_IA32_MCG_CAP_COUNT		0x000000ffUL
#define	MSR_IA32_MCG_CAP_CTL_P		0x00000100UL
#define	MSR_IA32_MCG_CAP_EXT_P		0x00000200UL
#define	MSR_IA32_MCG_CAP_CMCI_P		0x00000400UL
#define	MSR_IA32_MCG_CAP_TES_P		0x00000800UL
#define	MSR_IA32_MCG_CAP_EXT_CNT		0x00ff0000UL
#define	MSR_IA32_MCG_CAP_SER_P		0x01000000UL
#define	MSR_IA32_MCG_CAP_EMC_P		0x02000000UL
#define	MSR_IA32_MCG_CAP_ELOG_P		0x04000000UL
#define	MSR_IA32_MCG_CAP_LMCE_P		0x08000000UL
#define	MSR_IA32_MCG_STATUS_RIPV		0x00000001UL
#define	MSR_IA32_MCG_STATUS_EIPV		0x00000002UL
#define	MSR_IA32_MCG_STATUS_MCIP		0x00000004UL
#define	MSR_IA32_MCG_CTL_ENABLE		0xffffffffffffffffUL
#define	MSR_IA32_MCG_CTL_DISABLE		0x0000000000000000UL
#define	MSR_IA32_MC_CTL(x)		(MSR_IA32_MC0_CTL + (x) * 4)
#define	MSR_IA32_MC_STATUS(x)	(MSR_IA32_MC0_STATUS + (x) * 4)
#define	MSR_IA32_MC_ADDR(x)		(MSR_IA32_MC0_ADDR + (x) * 4)
#define	MSR_IA32_MC_MISC(x)		(MSR_IA32_MC0_MISC + (x) * 4)
#define	MSR_IA32_MC_CTL2(x)		(MSR_IA32_MC0_CTL2 + (x))	/* If MCG_CAP_CMCI_P */
#define	MSR_IA32_MC_STATUS_MCA_ERROR	0x000000000000ffffUL
#define	MSR_IA32_MC_STATUS_MODEL_ERROR	0x00000000ffff0000UL
#define	MSR_IA32_MC_STATUS_OTHER_INFO	0x01ffffff00000000UL
#define	MSR_IA32_MC_STATUS_COR_COUNT	0x001fffc000000000UL	/* If MCG_CAP_CMCI_P */
#define	MSR_IA32_MC_STATUS_TES_STATUS	0x0060000000000000UL	/* If MCG_CAP_TES_P */
#define	MSR_IA32_MC_STATUS_AR		0x0080000000000000UL /* If MCG_CAP_TES_P */
#define	MSR_IA32_MC_STATUS_S		0x0100000000000000UL /* If MCG_CAP_TES_P */
#define	MSR_IA32_MC_STATUS_PCC		0x0200000000000000UL
#define	MSR_IA32_MC_STATUS_ADDRV		0x0400000000000000UL
#define	MSR_IA32_MC_STATUS_MISCV		0x0800000000000000UL
#define	MSR_IA32_MC_STATUS_EN		0x1000000000000000UL
#define	MSR_IA32_MC_STATUS_UC		0x2000000000000000UL
#define	MSR_IA32_MC_STATUS_OVER		0x4000000000000000UL
#define	MSR_IA32_MC_STATUS_VAL		0x8000000000000000UL
#define	MSR_IA32_MC_MISC_RA_LSB		0x000000000000003fUL	/* If MCG_CAP_SER_P */
#define	MSR_IA32_MC_MISC_ADDRESS_MODE	0x00000000000001c0UL	/* If MCG_CAP_SER_P */
#define	MSR_IA32_MC_CTL2_THRESHOLD	0x0000000000007fffUL
#define	MSR_IA32_MC_CTL2_CMCI_EN		0x0000000040000000UL
