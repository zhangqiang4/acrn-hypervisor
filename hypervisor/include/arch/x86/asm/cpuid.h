...
/* CPUID.06H:EAX.Digital_temperature_sensor */
...
/* CPUID.06H:EAX.Hardware_Feedback_Notification  */
#define CPUID_EAX_HFN           (1U<<24U)
...
/* CPUID.07HEDX.ARCH_CAP*/
#define CPUID_EDX_ARCH_CAP	(1U<<29U)
